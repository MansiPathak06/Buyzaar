...
import { FaBullseye, FaRocket, FaCogs, FaUsers, FaMapMarkerAlt, FaUserTie, FaBullhorn, FaBoxes } from "react-icons/fa";
...
export default function FranchisePage() {
  return (
    <div className="bg-white min-h-screen mt-8 flex flex-col">
      ...
      <section className="relative isolate">
        ...
        <div className="relative max-w-4xl mx-auto px-4 py-20 flex flex-col items-center z-10">
          ...
          <p className="text-2xl text-white max-w-2xl text-center font-light">
            Unlock our proven business model, <span className="font-semibold">full operational support</span>, and a strong brand presence!
          </p>
        </div>
      </section>
      ...
      <section id="features" className="w-[75%] mx-auto my-12 p-15 bg-gray-50 rounded-xl shadow-md">
      ...
      <section className="max-w-7xl mx-auto my-12 p-0 rounded-2xl shadow-lg border border-gray-100 bg-white overflow-hidden">
        <div className="bg-black px-8 py-4 flex items-center justify-between rounded-t-2xl">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white text-2xl">Documents Required</span>
          </div>
        </div>
        <div className="px-8 pt-4 pb-0">
          ...
          <div className="mb-2 mt-4">
            <div className="font-bold text-gray-900 mb-2">Applicant's personal details:</div>
            <div className="space-y-2">
              ...
              <div className="bg-gray-50 rounded-lg px-4 py-2 flex items-start gap-2">
                <span className="mt-1 text-gray-600">&#9679;</span>
                <span>Address proof: Electricity Bill/Rent Agreement/Ration Card</span>
              </div>
            </div>
          </div>
          <div className="mb-2 mt-6">
            <div className="font-bold text-gray-900 mb-2">Details for Franchise Application:</div>
            <div className="space-y-2">
              <div className="bg-gray-50 rounded-lg px-4 py-2 flex items-start gap-2">
                <span className="mt-1 text-gray-600">&#9679;</span>
                <span>Educational Certificate: Certificate of Highest Education - 10th/12th/Grad/Post-Grad (Minimum 10th Pass)</span>
              </div>
              <div className="bg-gray-50 rounded-lg px-4 py-2 flex items-start gap-2">
                <span className="mt-1 text-gray-600">&#9679;</span>
              ...
              <div className="bg-gray-50 rounded-lg px-4 py-2 flex items-start gap-2">
                <span className="mt-1 text-gray-600">&#9679;</span>
                <span>Property Documents for Proposed Store: Ownership/Rental Agreement</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-3xl mx-auto mb-14 p-0 rounded-2xl shadow-xl border border-gray-100 bg-white overflow-hidden">
        ...
        <form className="px-8 py-6 space-y-7">
          {/* Personal Details */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Personal Details</h3>
            <div className="grid gap-4 md:grid-cols-2">
              <input type="text" className="input" placeholder="Full Name" required />
              <input type="text" className="input" placeholder="Father's/Husband's Name" required />
              ...
              <input type="text" className="input" placeholder="Mobile Number" required />
              <input type="email" className="input" placeholder="Email Address" required />
            </div>
          </div>
          {/* Identity Proof */}
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-2">Identity Proof</h3>
            <div className="grid gap-4 md:grid-cols-3">
              <input type="text" className="input" placeholder="Aadhaar Number" />
              <input type="text" className="input" placeholder="PAN Number" />
              <input type="text" className="input" placeholder="Voter ID Number" />
            </div>
            <input type="file" className="input mt-2" required />
            <span className="text-xs text-gray-500 ml-2">Attach Copy of Identity proof</span>
          </div>

          {/* Address */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Address Details</h3>
            <textarea className="input" placeholder="Full Permanent Address" required />
            <div className="grid gap-4 md:grid-cols-3 mt-2">
              <input type="text" className="input" placeholder="District" required />
              <input type="text" className="input" placeholder="State" required />
              <input type="text" className="input" placeholder="PIN Code" required />
            </div>
            <input type="file" className="input mt-2" required />
            <span className="text-xs text-gray-500 ml-2">Attach Copy of address proof</span>
          </div>

          {/* Education */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Educational Qualification</h3>
            <p className="text-sm mb-1 text-gray-600">Eligibility: Minimum 10th Pass</p>
            ...
            <span className="text-xs text-gray-500 ml-2">Attach Copy of last qualification marksheet/certificate</span>
          </div>

          {/* Work Experience */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Work Experience & Skills</h3>
            <textarea className="input" placeholder="Previous Business or Work Experience if any" />
            <textarea className="input mt-2" placeholder="Relevant Skills or Certifications if any" />
          </div>

          {/* Financial Info */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Financial Information</h3>
            <div className="grid gap-4 md:grid-cols-2">
              <select className="input" required>
                <option value="">Do you have ₹5,00,000 available to invest?</option>
                <option>Yes</option>
                <option>No</option>
              </select>
              <select className="input" required>
                <option value="">If No, do you wish to apply for a PMMY MUDRA Loan?</option>
                <option>Yes</option>
                <option>No</option>
              </select>
              <input type="text" className="input" placeholder="Current Monthly Family Income" required />
              <select className="input" required>
          ...
          {/* Banking Details */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Banking Details</h3>
            <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="grid gap-4 md:grid-cols-2 mt-2">
              <input type="text" className="input" placeholder="Account Number" required />
              <input type="text" className="input" placeholder="IFSC Code" required />
            </div>
            <input type="file" className="input mt-2" required />
            <span className="text-xs text-gray-500 ml-2">Attach Cancelled Cheque / Passbook Copy</span>
          </div>

          {/* Proposed Store Location */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">Proposed Store Location</h3>
            <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="grid gap-4 md:grid-cols-2 mt-2">
              ...
              <input className="input" placeholder="If leased, agreement duration" />
            </div>
            <input className="input mt-2" placeholder="Total Area (sq. ft.)" />
            <input type="file" className="input mt-2" />
            <span className="text-xs text-gray-500 ml-2">Attach Ownership/Rent/Lease proof</span>
          </div>

          {/* References */}
          <div>
            <h3 className="text-lg font-bold text-black mb-2">References - Two known persons (Optional)</h3>
            <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-xl bg-gray-50 p-6 shadow mt-6">
            <h4 className="font-semibold text-black mb-2">Agent/Employee Declaration (For Internal Performance Tracking)</h4>
            <p className="text-gray-700 text-sm mb-2">
              I declare that I was introduced to and assisted throughout the franchise onboarding process by the following representative/employee/agent of SRG Inoil Promotion Solutions Pvt. Ltd.
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              <input className="input" placeholder="SRG Representative Name" />
              <input className="input" placeholder="Designation/Role (if known)" />
              <input className="input" placeholder="Contact Number (if known)" />
            </div>
            ...
            <div className="flex items-center mt-3">
              ...
              <label htmlFor="independent" className="text-sm text-gray-700">
                I was not assisted by any SRG agent/employee and applied independently.
              </label>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-gray-100 p-6 mt-6 shadow border border-gray-200">
            ...
            <p className="text-sm text-gray-700 mb-2">
              I, the undersigned applicant, hereby declare that all the information and documents submitted in this franchise application form are true, correct, and complete to the best of my knowledge and belief.
            </p>
            <p className="text-sm text-gray-700 mb-2">
              I fully understand that the ₹10,000 application fee I am paying is completely non-refundable,
          ...
          <div className="flex gap-8 items-center mt-4">
            <input className="input w-auto" type="text" placeholder="Signature" required />
            <input className="input w-auto" type="date" placeholder="Date" required />
          </div>
          <button type="submit" className="w-full py-3 rounded-lg bg-black text-white font-semibold text-lg hover:bg-gray-800 transition shadow-xl mt-5">
            Submit Application
          </button>
        </form>
      </section>
